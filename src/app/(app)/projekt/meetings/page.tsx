...
import { getMeetings } from '@/lib/project-overview'

export default async function ProjektMeetingsPage({
  searchParams,
}: {
  ...
  const meetings = await getMeetings(supabase, project.id)
    ...
    <div className="mx-auto max-w-2xl p-8">
      <div className="mb-4 flex items-center justify-between">
        <div>
          ...
          <h1 className="text-2xl font-light">Meetings</h1>
        </div>
        <Link
