...
import { getCredentials } from '@/lib/project-overview'

export default async function ProjektZugangsdatenPage({
  searchParams,
}: {
  ...
  const credentials = await getCredentials(supabase, project.id)
    ...
    <div className="mx-auto max-w-2xl p-8">
      <div className="mb-4 flex items-center justify-between">
        <div>
          ...
          <h1 className="text-2xl font-light">Zugangsdaten</h1>
        </div>
        <Link
